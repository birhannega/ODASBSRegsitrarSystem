		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h3 style="font: bold italic 22px solid font-awesome"><span class="  glyphicon glyphicon-edit"  style="color:red"></span>New
						...
						<div class="form-group">
							<div class="input-group">
								<span class="input-group-addon" id="sizing-addon2" >Test
									...
									placeholder="Example: Assignment, test etc" aria-describedby="sizing-addon2">
							</div>
						</div>
						...
						<div class="form-group">
							<div class="input-group">
								<span class="input-group-addon" id="sizing-addon2">
									<span class="fa fa-percentile" >Mark in %</span></span> <input type="text" class="form-control"
									placeholder="mass of test %100" aria-describedby="sizing-addon2">
							</div>
						</div>
					</form>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<span class="pull-left"><strong>student mark update form</strong></span> &nbsp;
					&nbsp;
					&nbsp;
					<span class="form-group fa fa-1x ">
...
<form class="form-horizontal" method="post" action="">
      ...
      <div class="input-group-addon"> Grade</div> 
       <select class="form-control " name="optgrade" required="required">
