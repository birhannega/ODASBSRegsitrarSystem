...
<%@ include file="../includes/Tsidebar.jsp" %>
	 ...
	 if(result.next())
	 {
	   ...
	   else
	   {
		  ...
		  <h4 class=" page-header " style="margin-top:1px"> Dear User,sorry you are not home room teacher</h4>
		  <p>Links in this page needs the user to be <strong>Home room Teacher</strong></p>
		  </div>
		  </div>
