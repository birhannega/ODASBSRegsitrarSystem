...
<body>	
		...
		<div class="panel panel-primary">
		 ...
		 <select class="form-control"name="workassignment"required>
		       <option></option>
		...
		<h3 class="alert alert-info"style="color:red;"">home room teacher can't assigned in the database</h3>
	 		 <%}%>
...
if(!rsassigndteacher.isBeforeFirst()){
	%>
	<h3 class="alert alert-info"style="color:red;"">subject teacher can't assigned in the database</h3>
