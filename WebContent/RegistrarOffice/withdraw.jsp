...
<div
		class=" container-fluid col-md-12  col-lg-12 col-sm-12 col-xs-12 offset-2">
				...
				<div class="panel panel-heading "><strong>ODA Special Boarding  School Student withdraw
					 Form</strong></div>
...
<form action="${pageContext.request.contextPath }/Studentwithdraw"method="post"class="form-inline">
<% 
...
String studId=null,fname=null,lname=null,gender;String grade=null,branch=null;	String userid = session.getAttribute("registrar").toString();
...
ResultSet rsstuwithdraw=studentwithdraw.executeQuery("select *from TBL_student where Stud_id='"+studid+"' and branch='"+branch+"'and Status='Active'");
...
%>
<div class="">
<div class="form-inline pull-center">Withdraw student information</div>
...
<td><input type="submit"value="submit"></td>
					...
					<strong>The ID you entered didn't match to any student  try again
					</strong>
					<%}}}%>
