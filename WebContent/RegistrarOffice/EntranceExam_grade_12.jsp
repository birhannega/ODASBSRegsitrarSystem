...
<%String userid=session.getAttribute("registrar").toString(),branch=null;
	...
	<div class="panel panel-primary">
		...
		<p class="alert alert-info"><strong>${Existed} ${registerd} ${notregisterd}</strong> </p>
	  ...
	  <table class="table table-responsive table-bordered">				   
		...
		while(entranceexam.next()){
		   ...
		   <tr><form action="${pageContext.request.contextPath }/Grade_12_entrance"method="post"onsubmit="return chekForm(this)">
		...
		while(rssubject.next()){
			...
			String name=subjectname+i;
					%>
			<td>
			<input type="number" name="<%=id%>" class="form-control" required="required" min="1" max="100">
