...
<div class="panel ">
<div class="panel-heading"><strong>Re-Activate User Account</strong></div>
<div class="panel-body">
<div class="panel-content">
<strong><span style="color:green">${Activated}</span>
<span style="color:red">${notActivated}</span></strong>
<form class="form-inline" method="post" action="${pageContext.request.contextPath}/activateAccount">
  <div class="form-group">
    ...
    <div class="input-group">
      ...
      request.getSession().setAttribute("notActivated", null);
    		...
    		ResultSet res_users=statment_user.executeQuery("select TeacherId,userName from TBL_Users where currentState='Blocked'");
