...
<div class="panel-heading"><strong>Students Section Assignment form</strong></div>
<div class="panel-body">
<div class="panel-content">

<form class="form-inline" action="${pageContext.request.contextPath }/sectioning" id="section" method="post">
...
<h4 style="color:green">${SectionAssigned}</h4>
  ...
  <div class="form-group ">
    <label for="section">Section size</label>
    <input type="number"  name="size" class="form-control">

  </div>
  
  <div class="form-group ">
    <button type="submit" class="btn btn-primary    pull-right">Assign section</button>
    </div>
