...
%>
		...
		<%i=i+1; %>
		<div class="form-group col-md-4 col-lg-4">
			Zone:<input value="<%=resultSet.getString("zone") %>"
				name="<%=field+i %>" class="form-control">
		</div>
		<%i=i+1; %>
		<div class="form-group col-md-4 col-lg-4">
			wereda:<input value="<%=resultSet.getString("wereda") %>"
				name="<%=field+i %>" class="form-control">
		</div>
		<%i=i+1; %>
		<div class="form-group col-md-4 col-lg-4">
			hobby:<input value="<%=resultSet.getString("hobby") %>"
				name="<%=field+i %>" class="form-control">
		</div>
		<%i=i+1; %>
		<div class="form-group col-md-4 col-lg-4">
		...
		<%i=i+1; %>
		<div class="form-group col-md-4 col-lg-4">
			ODA Score :<input value="<%=resultSet.getString("odascore") %>"
				name="<%=field+i %>" class="form-control">
		</div>
