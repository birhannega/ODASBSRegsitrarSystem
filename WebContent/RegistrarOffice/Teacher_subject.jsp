...
else
{
	...
	ResultSet dbresultSet=dbStatement.executeQuery("select branch from TBL_Users where userName='"+session.getAttribute("registrar").toString()+"'");
if(dbresultSet.next())
{
...
<div class="panel-heading"><strong>Subject Teacher Assignment form</strong></div>
...
<form class="form-inline " action="" method="post">
  ...
  <button type="submit" class="btn btn-default">Choose Subject</button>
</form>
...
%>
	...
	<form action="${pageContext.request.contextPath}/Subject_teacher_Assignment" method="post" class="form-group">
<div><hr></div>
<span class="text-block text-right text-success">
<strong>
 ${overlimit} ${alreadyassigned}  ${assigned} ${notassigned} 
</strong>
</span>
<%
...
<strong>	select Teacher ID</strong>
	...
	ResultSet res_list_teacher=list_Teacher.executeQuery("Select TeacherId from TBL_teacher where Qualified='"+subject+"' and Status='Active'");
