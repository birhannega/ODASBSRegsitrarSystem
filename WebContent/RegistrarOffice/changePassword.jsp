			...
			<div class="container-fluid col-lg-9 col-md-9 pull-right">
				<div class="panel panel-default">
					...
					%>
						...
						<form id="changepassword" method="post" class="form-group  " action="${pageContext.request.contextPath}/ChangePassword">
							<h3>${added}</h3>
							   ${changed}
					         <h4>${failed}</h4>
							...
							<div class="form-group col-lg-6 col-md-6">
								...
								<div class=" ">
									<input  class="form-control" value="<%=logged_user_branch%>" id="branch" name="branch" readonly="readonly">
							...
							<div class="form-group col-lg-6 col-md-6">
								...
								<div class="">
									<input class="form-control" name="teacherid" value="<%=logged_user_id%>" readonly="readonly">
								</div>
							</div>
							...
							<div class="form-group col-lg-6 col-md-6">
								...
								<div class="">
									<input type="text" class="form-control" value="<%=logged_user_username %>" id="username1" name="username1" readonly="readonly" />
								</div>
							</div>

							<div class="form-group col-lg-6 col-md-6">
								<label class=" control-label" for="password1">Enter old Password</label>
								<div class="">
							...
							<div class="form-group ">
								<div class=" ">
									<button type="submit" class="btn btn-primary pull-right" name="signup1" >change password</button>
								</div>
							</div>
						</form>
					</div>
