...
<nav class="navbar navbar navbar-default " style="margin-top:-20px">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><strong><span class="text-info">ODASBS</span></strong></a>
    </div>

    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="active"><a href="#">Students center <span class="sr-only">(current)</span></a></li>
        <li><a href="#">User Accounts</a></li>
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Teachers center <span class="caret"></span></a>
...
<ol class="list-group col-lg-3 col-sm-12 col-xs-12 pull-right">

   <li class="list-group-item ">ODASBS This Year</li>
...
<p class="text-info text-uppercase"> <strong>welcome to central administrator panel</strong></p>
...
<li class="list-group-item"> <span class="text-info"> Activating and Closing Academic Year</span> </li>
