...
// ResultSet res=statement.executeQuery("");
 ...
 ResultSet results=Userstatement.executeQuery("select count(Subject_id) from TBL_Subject_Teacher where TeacherId=(select TeacherId from TBL_Users where userName='"+UserId+"')");
 while(results.next())
 {
...
<div class="panel-content ">
	<ul class="list-group ">
		<li class="list-group-item"><span
			...
			<a href="mysubjects.jsp" id="subjects"><strong>My Subjects</strong>  </a></li>
		...
		<li class="list-group-item"><span
			...
			<a href="myroom.jsp" id="report"><strong>My home Room</strong> </a></li>

		<li class="list-group-item"><span class="glyphicon  glyphicon-edit"></span> <a
			href="Testpanel.jsp" id="broadcast"><strong>Test Panel</strong></a></li>

		<li class="list-group-item"><span
			class="glyphicon glyphicon glyphicon glyphicon-user"></span> <a
			href="mystudents.jsp" id="broadcast"><strong>my students</strong> </a></li>
		<li class="list-group-item"><span
